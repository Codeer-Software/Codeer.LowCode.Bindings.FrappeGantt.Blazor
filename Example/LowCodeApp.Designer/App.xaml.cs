...
namespace LowCodeApp.Designer
{
    public partial class App : DesignerApp
    {
        ...
        {
            typeof(FrappeGanttFieldDesign).ToString();
            ...
            BlazorRuntime.InstallContentCss("FrappeGanttJS.Blazor", "/style.css");
            BlazorRuntime.InstallContentScript("FrappeGanttJS.Blazor", "/frappe-gantt.umd.js");
            BlazorRuntime.InstallContentScript("FrappeGanttJS.Blazor", "/main.js");
